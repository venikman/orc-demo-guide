...
function HoverCard({ delay, closeDelay, ...props }: PreviewCardPrimitive.Root.Props & { delay?: number; closeDelay?: number }) {
  return (
    <HoverCardDelayContext.Provider value={{ delay, closeDelay }}>
...
function HoverCardTrigger({ ...props }: PreviewCardPrimitive.Trigger.Props) {
  const { delay, closeDelay } = useContext(HoverCardDelayContext)
  return (
